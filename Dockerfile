...
ENV __doozer=update __doozer_group=rhel-8-golang-1.19 __doozer_key=openshift-golang-builder __doozer_uuid_tag=golang-builder-v1.19.13-20260226.163936 __doozer_version=v1.19.13 
...
LABEL \
        ...
        release="202602261639.p2.g276c5af.el8" \
        io.openshift.build.commit.id="276c5af610e32bfc8a0877eaff9bc3e476314ce8" \
        io.openshift.build.source-location="https://github.com/openshift-eng/ocp-build-data" \
        io.openshift.build.commit.url="https://github.com/openshift-eng/ocp-build-data/commit/276c5af610e32bfc8a0877eaff9bc3e476314ce8" \
