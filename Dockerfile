...
ENV __doozer=update __doozer_group=rhel-9-golang-1.19 __doozer_key=openshift-golang-builder __doozer_uuid_tag=golang-builder-v1.19.13-20260226.163936 __doozer_version=v1.19.13 
...
LABEL \
        ...
        vendor="Red Hat, Inc." \
        cpe="cpe:/a:redhat:openshift:1.19::el9" \
        com.redhat.component="openshift-golang-builder-container" \
        io.openshift.maintainer.project="OCPBUGS" \
        io.openshift.maintainer.component="Security" \
        release="202602261639.p2.g47c3be5.el9" \
        io.openshift.build.commit.id="47c3be55fffebf7926052ffab7ee3995c6befcda" \
        io.openshift.build.source-location="https://github.com/openshift-eng/ocp-build-data" \
        io.openshift.build.commit.url="https://github.com/openshift-eng/ocp-build-data/commit/47c3be55fffebf7926052ffab7ee3995c6befcda" \
