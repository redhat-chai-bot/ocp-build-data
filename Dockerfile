...
ENV __doozer=update __doozer_group=rhel-9-golang-1.22 __doozer_key=openshift-golang-builder __doozer_uuid_tag=golang-builder-v1.22.12-20260224.184757 __doozer_version=v1.22.12 
...
LABEL \
        ...
        vendor="Red Hat, Inc." \
        cpe="cpe:/a:redhat:openshift:1.22::el9" \
        com.redhat.component="openshift-golang-builder-container" \
        io.openshift.maintainer.project="OCPBUGS" \
        io.openshift.maintainer.component="Security" \
        release="202602241847.p2.g388ceb2.el9" \
        io.openshift.build.commit.id="388ceb2fb3d2ca010bfe3e6eb4cf9802a32aac77" \
        io.openshift.build.source-location="https://github.com/openshift-eng/ocp-build-data" \
        io.openshift.build.commit.url="https://github.com/openshift-eng/ocp-build-data/commit/388ceb2fb3d2ca010bfe3e6eb4cf9802a32aac77" \
