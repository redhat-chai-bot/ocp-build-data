...
ENV __doozer=update __doozer_group=rhel-8-golang-1.22 __doozer_key=openshift-golang-builder __doozer_uuid_tag=golang-builder-v1.22.12-20260206.173422 __doozer_version=v1.22.12 
...
LABEL \
        ...
        release="202602061734.g3a22db8.el8" \
