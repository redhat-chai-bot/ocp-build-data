...
ENV __doozer=update __doozer_group=rhel-9-golang-1.24 __doozer_key=openshift-golang-builder __doozer_uuid_tag=golang-builder-v1.24.13-20260224.144637 __doozer_version=v1.24.13 
...
LABEL \
        ...
        release="202602241446.p2.ge8e5642.el9" \
