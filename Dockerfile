...
ENV __doozer=update __doozer_group=rhel-9-golang-1.20 __doozer_key=openshift-golang-builder __doozer_uuid_tag=golang-builder-v1.20.12-20260225.155703 __doozer_version=v1.20.12 
...
LABEL \
        ...
        release="202602251556.p2.g5595e7d.el9" \
        io.openshift.build.commit.id="5595e7dcd49645574f993f7a3cfe978eeb573e27" \
        io.openshift.build.source-location="https://github.com/openshift-eng/ocp-build-data" \
        io.openshift.build.commit.url="https://github.com/openshift-eng/ocp-build-data/commit/5595e7dcd49645574f993f7a3cfe978eeb573e27" \
