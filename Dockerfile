...
ENV __doozer=update __doozer_group=rhel-8-golang-1.25 __doozer_key=openshift-golang-builder __doozer_uuid_tag=golang-builder-v1.25.3-20260206.203350 __doozer_version=v1.25.3 
...
LABEL \
        ...
        release="202602062033.gb36c047.el8" \
