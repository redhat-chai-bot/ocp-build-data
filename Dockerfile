...
ENV __doozer=update __doozer_group=rhel-8-golang-1.23 __doozer_key=openshift-golang-builder __doozer_uuid_tag=golang-builder-v1.23.10-20260224.180129 __doozer_version=v1.23.10 
...
LABEL \
        ...
        release="202602241801.p2.gdc331c7.el8" \
