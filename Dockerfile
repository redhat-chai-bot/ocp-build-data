...
ENV __doozer=update __doozer_group=rhel-8-golang-1.20 __doozer_key=openshift-golang-builder __doozer_uuid_tag=golang-builder-v1.20.12-20260225.155703 __doozer_version=v1.20.12 
...
LABEL \
        ...
        vendor="Red Hat, Inc." \
        cpe="cpe:/a:redhat:openshift:1.20::el8" \
        com.redhat.component="openshift-golang-builder-container" \
        io.openshift.maintainer.project="OCPBUGS" \
        io.openshift.maintainer.component="Security" \
        release="202602251556.p2.g6e050e4.el8" \
        io.openshift.build.commit.id="6e050e427935377b3d4a77a8374c9ac4dad74e7a" \
        io.openshift.build.source-location="https://github.com/openshift-eng/ocp-build-data" \
        io.openshift.build.commit.url="https://github.com/openshift-eng/ocp-build-data/commit/6e050e427935377b3d4a77a8374c9ac4dad74e7a" \
