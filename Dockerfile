...
ENV __doozer=update __doozer_group=rhel-8-golang-1.25 __doozer_key=openshift-golang-builder __doozer_uuid_tag=golang-builder-v1.25.3-20260207.173201 __doozer_version=v1.25.3 
...
LABEL \
        ...
        release="202602071731.gb36c047.el8" \
        io.openshift.build.commit.id="b36c0479fdda1afe10cd542df3c6181df5d07dfd" \
        io.openshift.build.source-location="https://github.com/openshift-eng/ocp-build-data" \
        io.openshift.build.commit.url="https://github.com/openshift-eng/ocp-build-data/commit/b36c0479fdda1afe10cd542df3c6181df5d07dfd" \
