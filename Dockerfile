...
ENV __doozer=update __doozer_group=rhel-9-golang-1.23 __doozer_key=openshift-golang-builder __doozer_uuid_tag=golang-builder-v1.23.10-20260206.182009 __doozer_version=v1.23.10 
...
LABEL \
        ...
        release="202602061820.gd0321dd.el9" \
