...
ENV __doozer=update __doozer_group=rhel-8-golang-1.23 __doozer_key=openshift-golang-builder __doozer_uuid_tag=golang-builder-v1.23.10-20260313.150946 __doozer_version=v1.23.10 
...
LABEL \
        ...
        io.k8s.display-name="Go Builder 1.23" \
        com.redhat.license_terms="https://www.redhat.com/en/about/red-hat-end-user-license-agreements#UBI" \
        version="v1.23.10" \
        name="openshift/golang-builder" \
        vendor="Red Hat, Inc." \
        cpe="cpe:/a:redhat:openshift:1.23::el8" \
        com.redhat.component="openshift-golang-builder-container" \
        io.openshift.maintainer.project="OCPBUGS" \
        io.openshift.maintainer.component="Security" \
        release="202603131509.p2.gdc331c7.el8" \
        io.openshift.build.commit.id="dc331c727bedf7094f8010f753ff3ea9efba55e8" \
        io.openshift.build.source-location="https://github.com/openshift-eng/ocp-build-data" \
        io.openshift.build.commit.url="https://github.com/openshift-eng/ocp-build-data/commit/dc331c727bedf7094f8010f753ff3ea9efba55e8" \
